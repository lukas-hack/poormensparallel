...
help parallel_aux_check
-------------------------------------------------------------------------------
Title
    parallel_aux_check -- Checks whether a folder exists and whether one has 
                          writing rights

Syntax
    parallel_aux_check, path(string)
...
Examples
    . parallel_aux_check, path("parallel_jobs")
