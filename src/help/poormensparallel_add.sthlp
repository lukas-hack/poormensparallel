...
-------------------------------------------------------------------------------
Title
    parallel_add -- Input program that takes header and jobs to create master 
                    do file

Syntax
    parallel_add, input(string) [clearparallel continuejob header clearheader preserve(string)]
...
Examples
    . parallel_add, input("job1.do") clearparallel
    . parallel_add, input("job2.do") continuejob
    . parallel_add, input("header line") header
