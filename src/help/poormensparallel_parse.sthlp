...
-------------------------------------------------------------------------------
Title
    parallel_parse -- Parser that creates do file from input strings

Syntax
    parallel_parse, [doname(string) dirname(string) replace runparallel]
...
Examples
    . parallel_parse, doname("master.do") dirname("parallel_jobs") replace
    . parallel_parse, doname("master.do") runparallel
